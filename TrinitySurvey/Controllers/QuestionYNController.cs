...
{
    public class QuestionsYNController : Controller
    {
        private readonly QuestionYNService _questionService;
        private readonly ResponseYNService _responseService;

        public QuestionsYNController(QuestionYNService questionService, ResponseYNService responseService)
        {
